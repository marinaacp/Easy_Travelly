...
# countrycodes = ['ES', 'BR', 'FR', 'UK', 'PT', 'IT', 'DE']
...
#     )
#     puts "Creating destination #{destination['name']['content']} - #{new_destination.country.name}"
...
#     )
#   end
#   puts "Created destination for #{code}"
#   sleep(30)
# end
###############################################################################
...
# Populating some Destinations
cities = ['Florence', 'Rome', 'Lisbon', 'Zürich', 'Geneva', 'Athens', 'Brussels', 'Dublin', 'Copenhagen', 'Amsterdam', 'Vienna', 'Budapest']
cities_codes = %w[FLR ROM LIS ZRH GVA ATH BRU DUB CPH AMS VDD BUD]
countries = ["Italy", "Italy", 'Portugal', 'Switzerland', 'Switzerland', 'Greece', 'Belgium', 'Ireland', 'Denmark', 'Netherlands', 'Austria', 'Hungary']
