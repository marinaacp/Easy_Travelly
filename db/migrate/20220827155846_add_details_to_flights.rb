class AddDetailsToFlights < ActiveRecord::Migration[6.1]
  def change
    ...
    add_column :flights, :departure_start_time, :string
    add_column :flights, :departure_end_time, :string
    ...
    add_column :flights, :return_start_time, :string
    add_column :flights, :return_end_time, :string
